...
python3 newExample-compas.py --epsilon=${SLURM_ARRAY_TASK_ID} --filteringMode=2 --maxTime=300
python3 newExample-compas.py --epsilon=${SLURM_ARRAY_TASK_ID} --filteringMode=2 --maxTime=600
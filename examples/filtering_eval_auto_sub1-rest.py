...
epsilon = 0# 0.995 #0.999# 0.995#0.99#0.995#0.995#0.995 #0.999#0.995 #cart_product[expe_id][1]
seed = 0#cart_product[expe_id][2]
fairnessMetric = 1#cart_product[expe_id][3]
max_time = 2400#cart_product[expe_id][4]
filteringMode = 0#cart_product[expe_id][5]
...
max_memory = 5000
policy= "bfs"#"bfs"
fileName = 'adult_income_fullRules-rest.csv' # 'marketing_fullRules.csv'# '%s_rules_full_single.csv' %dataset #'adult_income_fullRules.csv' #
...
print("Training acc is :", accTraining)

...
python3 newExample-compas-singleOPT.py --epsilon=${SLURM_ARRAY_TASK_ID} --filteringMode=1 --maxTime=600
...
python3 newExample-compas-singleOPT.py --epsilon=${SLURM_ARRAY_TASK_ID} --filteringMode=1 --maxTime=600 --policy="objective"

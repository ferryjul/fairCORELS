...
def statistical_parity():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=1) for eps in epsilon_range]
...
def predictive_parity():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=2) for eps in epsilon_range]
    df = pd.DataFrame(row_list)
    df.to_csv(filename, encoding='utf-8', index=False)
...
def predictive_equality():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=3) for eps in epsilon_range]
    df = pd.DataFrame(row_list)
    df.to_csv(filename, encoding='utf-8', index=False)
...
def equal_opportunity():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=4) for eps in epsilon_range]
    df = pd.DataFrame(row_list)
    df.to_csv(filename, encoding='utf-8', index=False)
...
def equalized_odds():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=5) for eps in epsilon_range]
    df = pd.DataFrame(row_list)
    df.to_csv(filename, encoding='utf-8', index=False)
...
def conditional_use_accuracy_equality():
    ...
    row_list = [per_epsilon(epsilon=eps, fairness_metric=6) for eps in epsilon_range]
    df = pd.DataFrame(row_list)
    df.to_csv(filename, encoding='utf-8', index=False)

...
with_file <- sprintf("../pareto/compas_%s_with_dem.csv", metric)
without_file <- sprintf("../pareto/compas_%s_without_dem.csv", metric)
with_laftr_file <- sprintf("../pareto/compas_%s_with_dem_laftr.csv", metric)
without_laftr_file <- sprintf("../pareto/compas_%s_without_dem_laftr.csv", metric)


output_file <- sprintf("./graphs/compas_%s.pdf", metric)

...
file_us     <- sprintf("../pareto/faircorels/adult_no_relationship/%s.csv", metric)
file_laftr  <- sprintf("../pareto/laftr/adult_no_relationship/%s.csv", metric)
file_zafar  <- sprintf("../pareto/zafar/adult_no_relationship/%s.csv", metric)

output_file <- sprintf("./graphs/adult_no_relationship_%s.pdf", metric)

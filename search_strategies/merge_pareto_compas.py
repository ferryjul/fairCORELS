...
datasets = ['compas_neg_without_ulb', 'compas_neg_with_ulb']
...
datasets_map = {
    'compas_neg_without_ulb': 'without ULB',
    'compas_neg_with_ulb': 'with ULB'
}
...
df = pd.DataFrame()
filename = './pareto_merged/compas_both.csv'
